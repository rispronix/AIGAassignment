...
//
        ...
        new AverageNRuns(10,
                new Function3MergeRecombination(seed, 100, 100, 0.9, 0.5, 10));

        System.out.print("\nExperiment 6: Function3 with best of four tournament "
                + "selection and merge recombination (10 variables)");
        new AverageNRuns(10,
                new Function3BestOfFourSelection(seed, 100, 100, 0.9, 0.5, 10));

        System.out.print("\nExperiment 7: Function3 with best of four tournament "
                + "selection and merge recombination (20 variables)");
        new AverageNRuns(10,
                new Function3BestOfFourSelection(seed, 100, 100, 0.9, 0.5, 20));

        System.out.print("\nExperiment 8: probability parameter search on function"
                + " 3 with best of four selection and merge recombination (20 variables)");
        new ProbabilitySearch(seed, 10, 100, 0.9, 0.5,
                new Function3BestOfFourSelection(seed,
                        100, 100, 0.9, 0.8, 20)).run();
